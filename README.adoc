...
Expecting that you have a JRE installed, this can be done with the following command:

* Please provide the absolute path from your application yml,
in the command below I'm using the path from my local file.
