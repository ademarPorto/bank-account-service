...
public class AccountRequestMapperTest extends TestBase {
    ...
    @Autowired
    private AccountRequestMapperImpl accountMapper;
    ...
    void testFromSpecToAccountModel() {
        ...
        assertThat(accountRequestModel.address().streetName()).isEqualTo(accountDto.getAddress().getStreetName());
        assertThat(accountRequestModel.address().houseNumber()).isEqualTo(accountDto.getAddress().getHouseNumber());
        assertThat(accountRequestModel.address().postCode()).isEqualTo(accountDto.getAddress().getPostCode());
        ...
        assertThat(accountRequestModel.accountType().name()).isEqualTo(accountDto.getAccountType().name());
        ...
        assertThat(accountRequestModel.interestedInOtherProducts()).isEqualTo(accountDto.getInterestedInOtherProducts());
    ...
    void testFromEntityToAccountModel() {
        ...
        assertThat(accountRequestModel.address()).isNotNull();
        assertThat(accountRequestModel.address().streetName()).isEqualTo(accountEntity.getAddress().getStreetName());
        assertThat(accountRequestModel.address().houseNumber()).isEqualTo(accountEntity.getAddress().getHouseNumber());
        assertThat(accountRequestModel.address().postCode()).isEqualTo(accountEntity.getAddress().getPostCode());
        assertThat(accountRequestModel.address().city()).isEqualTo(accountEntity.getAddress().getCity());
        ...
        assertThat(accountRequestModel.accountType().name()).isEqualTo(accountEntity.getAccountType().name());
        ...
        assertThat(accountRequestModel.interestedInOtherProducts()).isEqualTo(accountEntity.getInterestedInOtherProducts());
    ...
    void testFromAccountModelToAccountEntity() {
        ...
        assertThat(accountRequestEntity.getAddress().getStreetName() ).isEqualTo(accountRequestModel.address().streetName());
        assertThat(accountRequestEntity.getAddress().getHouseNumber()).isEqualTo(accountRequestModel.address().houseNumber());
        assertThat(accountRequestEntity.getAddress().getPostCode()).isEqualTo(accountRequestModel.address().postCode());
        assertThat(accountRequestEntity.getAddress().getCity()).isEqualTo(accountRequestModel.address().city());
        ...
        assertThat(accountRequestEntity.getAccountType().name()).isEqualTo(accountRequestModel.accountType().name());
        assertThat(accountRequestEntity.getStartingBalance()).isEqualTo(accountRequestModel.startingBalance());
        assertThat(accountRequestEntity.getMonthlySalary()).isEqualTo(accountRequestModel.monthlySalary());
        assertThat(accountRequestEntity.getInterestedInOtherProducts()).isEqualTo(accountRequestModel.interestedInOtherProducts());
    ...
    void testFromAccountModelToAccountDto() {
        ...
        assertThat(accountRequestDto.getAddress().getStreetName()).isEqualTo(accountRequestModel.address().streetName());
        assertThat(accountRequestDto.getAddress().getHouseNumber()).isEqualTo(accountRequestModel.address().houseNumber());
        assertThat(accountRequestDto.getAddress().getPostCode()).isEqualTo(accountRequestModel.address().postCode());
        assertThat(accountRequestDto.getAddress().getCity()).isEqualTo(accountRequestModel.address().city());
        ...
        assertThat(accountRequestDto.getAccountType().name()).isEqualTo(accountRequestModel.accountType().name());
        assertThat(accountRequestDto.getStartingBalance()).isEqualTo(accountRequestModel.startingBalance());
        assertThat(accountRequestDto.getMonthlySalary()).isEqualTo(accountRequestModel.monthlySalary());
        assertThat(accountRequestDto.getInterestedInOtherProducts()).isEqualTo(accountRequestModel.interestedInOtherProducts());
