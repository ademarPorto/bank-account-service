...
public class AccountRequestFactory {
  ...
  public static AccountRequest createAccountRequest(
      String idDocument, AccountType accountType, AccountStatus accountStatus) {
    return createAccountRequest(REQUEST_ID, idDocument, accountType, accountStatus);
  }

  public static AccountRequest createAccountRequest(
      UUID requestId, String idDocument, AccountType accountType, AccountStatus accountStatus) {
  ...
  public static Address createAddress() {
    return new Address(STREET_NAME, HOUSE_NUMBER, POST_CODE, CITY);
  }
