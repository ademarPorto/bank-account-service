...
public class AccountRequestControllerIT extends TestBase {
    ...
    @Test
    void when_CreateNewAccountRequest_InvalidAddressStreetNameThenReturn_BadRequest() throws Exception {
        var request = createAccountRequestDto();
        ...
        assertThat(response.getCode()).isEqualTo(INVALID_PARAMETER_ERROR_CODE);
        assertThat(response.getMessage())
                .isEqualTo("Invalid parameter: [ account.address.streetName ], cause: field [ must not be null ].");
    }

    @Test
    void when_CreateNewAccountRequest_InvalidAddressHouseNumberThenReturn_BadRequest() throws Exception {
        var request = createAccountRequestDto();
        ...
        assertThat(response.getCode()).isEqualTo(INVALID_PARAMETER_ERROR_CODE);
        assertThat(response.getMessage())
                .isEqualTo("Invalid parameter: [ account.address.houseNumber ], cause: field [ must not be null ].");
    }

    @Test
    void when_CreateNewAccountRequest_InvalidAddressNullPostCodeThenReturn_BadRequest() throws Exception {
        var request = createAccountRequestDto();
        ...
        assertThat(response.getCode()).isEqualTo(INVALID_PARAMETER_ERROR_CODE);
        assertThat(response.getMessage())
                .isEqualTo("Invalid parameter: [ account.address.postCode ], cause: field [ must not be null ].");
    }
    ...
    void when_CreateNewAccountRequest_InvalidAddressPostCodeThenReturn_BadRequest() throws Exception {
        ...
        assertThat(response.getCode()).isEqualTo(INVALID_PARAMETER_ERROR_CODE);
        assertThat(response.getMessage())
                .isEqualTo("Invalid parameter: [ account.address.postCode ], cause: field [ must match \"^\\d{4} [A-Z]{2}$\" ].");
    }
    ...
    void when_CreateNewAccountRequest_InvalidAddressCityThenReturn_BadRequest() throws Exception {
        ...
        assertThat(response.getCode()).isEqualTo(INVALID_PARAMETER_ERROR_CODE);
        assertThat(response.getMessage())
                .isEqualTo("Invalid parameter: [ account.address.city ], cause: field [ must not be null ].");
    }
    ...
    void when_CreateNewAccountRequest_InvalidDateOfBirthThenReturn_BadRequest() throws Exception {
        ...
        assertThat(response.getCode()).isEqualTo(INVALID_PARAMETER_ERROR_CODE);
        assertThat(response.getMessage())
                .isEqualTo("Invalid parameter: [ account.dateOfBirth ], cause: field [ must not be null ].");
    }
    ...
    @Test
    void when_CreateNewAccountRequest_InvalidIdDocumentButStatusPausedThenReturn_ShouldPass() throws Exception {
        var request = createAccountRequestDto();
        request.getAccount().setIdDocument(null);
    ...
    @Test
    void when_CreateNewAccountRequest_InvalidAccountTypeButStatusPausedThenReturn_ShouldPass() throws Exception {
        var request = createAccountRequestDto();
        request.getAccount().setAccountType(null);
        request.getAccount().setAccountStatus(AccountStatusDto.PAUSED);
    ...
    void when_UpdateAccountRequest_ThenReturn_Ok() throws Exception {
        ...
        var mvcResult = mockMvc
                .perform(put(ACCOUNT_REQUEST_ENDPOINT)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(request)))
        ...
        assertThat(response.getAccount().getAccountStatus()).isEqualTo(request.getAccount().getAccountStatus());
    }

    @Test
    void when_UpdateAccountRequest_IfAccountAlreadySubmitted_ThenReturn_BadRequest() throws Exception {
        var accountRequestEntity = createAccountRequestEntity();
        ...
        assertThat(response.getMessage()).isEqualTo(String.format(SUBMITTED_ACCOUNT_ERROR_MESSAGE,
    ...
    void when_DeleteAccountRequest_ThenReturn_NoContent() throws Exception {
        ...
        mockMvc
                .perform(delete(String.format(ACCOUNT_REQUEST_ENDPOINT_WITH_PARAMETER,
                        storedAccountRequest.getRequestId()))
                        .contentType(MediaType.APPLICATION_JSON))
    ...
    void when_DeleteAccountRequest_AccountNotPresent_ThenReturn_BadRequest() throws Exception {
        ...
        assertThat(response.getMessage()).isEqualTo(String.format(ACCOUNT_NOT_FOUND_MESSAGE, REQUEST_ID));
    }
    ...
    void when_GetAccountRequestById_ThenReturn_Ok() throws Exception {
        ...
        var mvcResult = mockMvc
                .perform(get(String.format(ACCOUNT_REQUEST_ENDPOINT_WITH_PARAMETER,
                        storedAccountRequest.getRequestId()))
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andReturn().getResponse().getContentAsString();
    ...
    void when_SubmitAccountRequest_ThenReturn_NoContent() throws Exception {
        ...
        mockMvc
                .perform(get(String.format(ACCOUNT_REQUEST_SUBMIT_ENDPOINT, storedAccountRequest.getRequestId()))
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isNoContent());
    ...
    void when_SubmitAccountRequest_AccountNotPresent_ThenReturn_BadRequest() throws Exception {
        var mvcResult =  mockMvc
                .perform(get(String.format(ACCOUNT_REQUEST_SUBMIT_ENDPOINT, REQUEST_ID))
                        .contentType(MediaType.APPLICATION_JSON))
                .andReturn()
                .getResponse()
                .getContentAsString();
    ...
    @Test
    void when_SubmitAccountRequest_AccountMissingAccountType_ThenReturn_BadRequest() throws Exception {
        var accountRequestEntity = createAccountRequestEntity();
