...
public class ControllerExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        return createResponseEntity(INVALID_PARAMETER_ERROR_CODE,
                String.format(INVALID_PARAMETER_ERROR_MESSAGE,
    ...
    protected ResponseEntity<Object> handleAccountNotFoundException(AccountRequestNotFoundException ex, WebRequest request) {
        return createResponseEntity(ex.getCode(), ex.getMessage(), HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler(InputValidationException.class)
    protected ResponseEntity<Object> handleInputValidationException(InputValidationException ex, WebRequest request) {
        return createResponseEntity(ex.getCode(), ex.getMessage(), HttpStatus.BAD_REQUEST);
    }
